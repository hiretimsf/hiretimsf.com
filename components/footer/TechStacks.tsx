...
export default function TechStacks() {
  return (
    <div className="mx-auto mt-4 max-w-xl flex-row items-center justify-center mb-4 px-4">
      <p className="text-muted-foreground hidden text-center text-sm leading-5 sm:block">
        Loosely designed in{" "}
        <Link
