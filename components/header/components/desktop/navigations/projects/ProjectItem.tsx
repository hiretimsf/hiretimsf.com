...
const ProjectItem: FC<Props> = ({ title, description, href, image }) => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="relative size-full overflow-hidden rounded-tl-lg border-t border-l border-black/10 mask-[linear-gradient(black_50%,transparent)]">
          {isLoading && (
          ...
          {hasError ? (
            ...
            <Image
              ...
              fill
              className="bg-background object-cover object-top-left grayscale transition-all duration-300 group-hover:grayscale-0"
